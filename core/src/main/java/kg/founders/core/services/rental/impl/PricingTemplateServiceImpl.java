...
import kg.founders.core.converter.rental.PricingTemplateConverter;
...
public class PricingTemplateServiceImpl implements PricingTemplateService {
    ...
    private final PricingTemplateConverter pricingTemplateConverter;

    @Transactional(readOnly = true)
    @Override
    public List<PricingTemplateDto> getAllTemplates() {
        return templateRepository.findAllWithTiers().stream()
                .map(pricingTemplateConverter::convertFromEntity)
    ...
    public PricingTemplateDto getTemplateById(Long id) {
        ...
        return pricingTemplateConverter.convertFromEntity(template);
    }
